  ...
  if (isVideoFile(file)) {
    return (
      <>
        ...
        <Button variant="outline" size="icon" className="size-8" onClick={() => handlePlayVideo(file)}>
  ...
  if (isPdfFile(file)) {
    return (
      <>
        ...
        <Button variant="outline" size="icon" className="size-8" onClick={() => handleViewPdf(file)}>
